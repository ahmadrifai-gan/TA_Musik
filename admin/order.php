...
if (isset($_POST['update'])) {
  ...
  if ($result) {
    ...
    echo "<script>alert('Error: " . mysqli_error($koneksi) . "'); window.location='order.php';</script>";
  }
  exit;
}
?>
...
$(document).ready(function(){
  ...
  $(document).on('click', '.lihatBtn', function(){
    ...
    if(pembayaran === 'sudah_dibayar') $('#detailPembayaran').html('<span class="badge badge-success">Sudah Dibayar</span>');
  ...
  $(document).on('click', '.editBtn', function(){
    ...
    console.log('Pembayaran Type:', typeof pembayaran);
    ...
    console.log('Selected payment:', $('#edit_pembayaran').val());

    $('#edit_studio option').each(function(){
      if($(this).text() === studio){ 
